...
const faqs = [
  {
    question: "Is Budgetly free to use?",
    answer: "Yes! Budgetly offers a free plan with core features including expense tracking, income logging, and basic budgets. You can upgrade to Premium for advanced analytics, net worth tracking, and more.",
  },
  {
  ...
  {
    question: "Is Budgetly available on Android?",
    answer: "Budgetly is currently available exclusively on iOS. We're exploring an Android version — stay tuned for updates!",
  },
  {
