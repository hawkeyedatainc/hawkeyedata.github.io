...
const sections = [
  {
    ...
    content: [
      "Budgetly is designed so your financial data stays on your device.",
  ...
  },
  {
    title: "4. Data Export",
    content: [
      "Budgetly lets you export your data to spreadsheet files.",
  ...
  },
  {
    ...
    content: [
      "Budgetly is not directed to children under 13 (or the minimum age in your region).",
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h1 className="font-display text-4xl font-bold md:text-5xl">
                Privacy Policy for <span className="gradient-text">Budgetly</span>
              </h1>
              ...
              <p className="mt-5 max-w-2xl text-lg text-foreground/90">
                Budgetly is a local-first personal finance app.
              </p>
            </div>
            <motion.div
            ...
            >
              <BudgetlyLogo className="h-16 w-16" />
              <div className="glass-card p-3">
                <img
                  src={screenshot8}
                  alt="Budgetly app insights view"
        ...
        >
          <div className="glass-card p-7">
            ...
            <p className="mt-3 text-muted-foreground">
              Your finances stay local to your device, and your export choices stay in your control. That is the foundation of Budgetly.
            </p>
          </div>
          <div className="phone-frame mx-auto w-[220px] glow-blue md:mx-0">
            <img
              src={screenshot3}
              alt="Budgetly app budget screen"
