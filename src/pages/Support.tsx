            ...
            <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
              <div>
                ...
                <h1 className="font-display text-4xl font-bold md:text-5xl">
                  Contact <span className="gradient-text">Budgetly</span>
                </h1>
                <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
                  We built Budgetly to be local-first and privacy-focused. If you need help, have a feature request, or have a privacy question, we are here for you.
                </p>
                <a
                  href="mailto:learn@hawkeyedata.ca?subject=Budgetly%20Support"
              ...
              >
                ...
                <div className="glass-card p-3">
                  <img
                    src={screenshot9}
                    alt="Budgetly app analytics view"
          ...
          <section className="grid gap-6 md:grid-cols-[1fr_0.9fr]">
            ...
            >
              ...
              <form
                ...
                onSubmit={(e) => {
                  e.preventDefault();
                  window.location.href = "mailto:learn@hawkeyedata.ca?subject=Budgetly%20Inquiry";
                }}
              >
                <div>
            ...
            >
              ...
              <div className="mt-6 phone-frame mx-auto w-[220px] glow-blue">
                <img
                  src={screenshot6}
                  alt="Budgetly app transactions screen"
